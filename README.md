...
Input: User provides an image and a textual description.

Caption Generation: The system generates a caption describing the image.

Embedding Extraction: Convert both the generated caption and input text into semantic embeddings.

Similarity Computation: Calculate a similarity score between the embeddings.

Verdict: Output a consistency score and an interpretable alignment result (e.g., Consistent or Inconsistent).
